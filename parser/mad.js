...
var grammar = {
    ...
    {"name": "exp$ebnf$1", "symbols": ["comm"], "postprocess": id},
    {"name": "exp$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "exp", "symbols": ["exp$subexpression$1", "exp$ebnf$1"], "postprocess": ([e]) => e},
    ...
    {"name": "attr$ebnf$1$subexpression$1", "symbols": ["_", "comm"]},
    {"name": "attr$ebnf$1", "symbols": ["attr$ebnf$1", "attr$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "attr$ebnf$2$subexpression$1", "symbols": ["attrs", "_"]},
    ...
    {"name": "attr$ebnf$3", "symbols": []},
    {"name": "attr$ebnf$3$subexpression$1", "symbols": ["_", "comm"]},
    {"name": "attr$ebnf$3", "symbols": ["attr$ebnf$3", "attr$ebnf$3$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "attr", "symbols": [{"literal":"{"}, "attr$ebnf$1", "_", "attr$ebnf$2", "attr$ebnf$3", {"literal":"}"}], "postprocess": ([,,,attrs])     => attrs?.[0] || []},
    ...
    {"name": "boolAtt$ebnf$1$subexpression$1", "symbols": ["_", "comm"]},
    {"name": "boolAtt$ebnf$1", "symbols": ["boolAtt$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "boolAtt$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "boolAtt", "symbols": ["word", "boolAtt$ebnf$1"], "postprocess": ([w])            => fmtAttribute("bool",  null,    w)},
    {"name": "namedAttr$ebnf$1$subexpression$1", "symbols": ["_", "comm"]},
    {"name": "namedAttr$ebnf$1", "symbols": ["namedAttr$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "namedAttr$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "namedAttr", "symbols": ["word", "_", {"literal":"="}, "_", "aplhanum", "namedAttr$ebnf$1"], "postprocess": ([w,,,,a])       => fmtAttribute("named", w,       a)},
    {"name": "class$ebnf$1$subexpression$1", "symbols": ["_", "comm"]},
    ...
    {"name": "class", "symbols": [{"literal":"."}, "word", "class$ebnf$1"], "postprocess": ([,w])           => fmtAttribute("class", null,    w)},
    {"name": "id$ebnf$1$subexpression$1", "symbols": ["_", "comm"]},
    {"name": "id$ebnf$1", "symbols": ["id$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "id$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "id", "symbols": [{"literal":"#"}, "word", "id$ebnf$1"], "postprocess": ([,w])           => fmtAttribute("id",    null,    w)},
    {"name": "comp", "symbols": [(lexer.has("at") ? {type: "at"} : at), "word", "_"], "postprocess": ([,w])          => fmtComponent(w, [])},
    {"name": "comp$ebnf$1", "symbols": []},
    {"name": "comp$ebnf$1$subexpression$1", "symbols": ["_", "comm"]},
    {"name": "comp$ebnf$1", "symbols": ["comp$ebnf$1", "comp$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "comp$ebnf$2$subexpression$1", "symbols": ["args", "_"]},
    ...
    {"name": "comp", "symbols": [(lexer.has("at") ? {type: "at"} : at), "word", "_", {"literal":"{"}, "comp$ebnf$1", "_", "comp$ebnf$2", {"literal":"}"}, "_"], "postprocess": ([,w,,,,,args]) => fmtComponent(w, args?.[0] || [])},
    {"name": "args$ebnf$1", "symbols": []},
    {"name": "args$ebnf$1$subexpression$1", "symbols": ["_", "comm"]},
    {"name": "args$ebnf$1", "symbols": ["args$ebnf$1", "args$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "args$ebnf$2$subexpression$1$ebnf$1", "symbols": []},
    {"name": "args$ebnf$2$subexpression$1$ebnf$1$subexpression$1", "symbols": ["_", "comm"]},
    {"name": "args$ebnf$2$subexpression$1$ebnf$1", "symbols": ["args$ebnf$2$subexpression$1$ebnf$1", "args$ebnf$2$subexpression$1$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "args$ebnf$2$subexpression$1$ebnf$2$subexpression$1", "symbols": ["_", "args"]},
    {"name": "args$ebnf$2$subexpression$1$ebnf$2", "symbols": ["args$ebnf$2$subexpression$1$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "args$ebnf$2$subexpression$1$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "args$ebnf$2$subexpression$1", "symbols": ["_", {"literal":","}, "args$ebnf$2$subexpression$1$ebnf$1", "args$ebnf$2$subexpression$1$ebnf$2"]},
    ...
    {"name": "args", "symbols": ["arg", "args$ebnf$1", "args$ebnf$2"], "postprocess": ([arg,,args])   => args?.[3] ? [arg, ...args[3][1]] : [arg]},
    ...
    {"name": "comm", "symbols": [(lexer.has("comment") ? {type: "comment"} : comment)], "postprocess": ([n]) => n}
]
  , ParserStart: "mad"
}
