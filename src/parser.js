...
var grammar = {
    ...
    {"name": "h1", "symbols": ["crs", "empty", {"literal":"#"}], "postprocess": ([crs])       => ({t:'h1',    s:crs.length, v:''         })},
    ...
    {"name": "h2", "symbols": ["crs", "empty", "h2$string$2"], "postprocess": ([crs])       => ({t:'h2',    s:crs.length, v:''          })},
    ...
    {"name": "h3", "symbols": ["crs", "empty", "h3$string$2"], "postprocess": ([crs])       => ({t:'h3',    s:crs.length, v:''          })},
    ...
    {"name": "h4", "symbols": ["crs", "empty", "h4$string$2"], "postprocess": ([crs])       => ({t:'h4',    s:crs.length, v:''          })},
    ...
    {"name": "h5", "symbols": ["crs", "empty", "h5$string$2"], "postprocess": ([crs])       => ({t:'h5',    s:crs.length, v:''          })},
    {"name": "h6$string$1", "symbols": [{"literal":"#"}, {"literal":"#"}, {"literal":"#"}, {"literal":"#"}, {"literal":"#"}, {"literal":"#"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "h6", "symbols": ["crs", "empty", "h6$string$1", "line"], "postprocess": ([crs,,,l])   => ({t:'h6',    s:crs.length, v:join(l)     })},
    {"name": "p", "symbols": ["crs", "empty", /[^#>`\s:]/, "line"], "postprocess": ([crs,,c,l])  => ({t:'p',     s:crs.length, v:c.trim('') + join(l)})},
    {"name": "quote", "symbols": ["crs", "empty", {"literal":">"}, "line"], "postprocess": ([crs,,,l])   => ({t:'quote', s:crs.length, v:join(l)     })},
    {"name": "code", "symbols": ["crs", "empty", {"literal":"`"}, "line"], "postprocess": ([crs,,,l])   => ({t:'code',  s:crs.length, v:raw(l)      })},
